...
export class LoadScreen extends AppScreen {
    ...
    constructor() {
        ...
        this.addContent({
            // add children components (can be sprite or any container based pixi instance like Layout) to the Layout

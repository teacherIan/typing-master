...
export class GameScreen extends AppScreen {
    ...
    constructor(options: SceneData) {
        ...
        if (options?.level) {
            // if level is passed to the screen
    ...
    private addPauseButton() {
        const button = new SmallIconButton('PauseIcon', () => {
    ...
    private addHealthBar() {
        ...
        this.addContent({
            ...
            styles: {
                // set styles for the health block
    ...
    private addEnergyBar() {
        ...
        this.addContent({
            ...
            styles: {
                // set styles for the energy block

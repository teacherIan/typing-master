...
export class LevelsWindow extends Window {
    ...
    private createLevelButtons() {
        this.addContent({
            // add the level buttons to the layout system of the Window
            levels: {
                // 'levels' is the id of the layer
    ...
    private get levels(): Sprite[] {
        ...
        const openLevels = 15; // set the amount of open levels (TODO: to be abstracted to a game state controller)
    ...
    private createNavigationButtons() {
        ...
        this.addContent({
            // add the buttons to the layout system of the screen
            bottomMenu: {
                // id of the layout
                content: {
                    // content is an object with all the elements that will be added to the layout
                    homeButton: {
